...
{
	public static final PropertyDirection FACING = BlockHorizontal.FACING; // facing direction
	public static final PropertyBool BURNING = PropertyBool.create("burning"); // if its burning or not
	...
	public static void setState(boolean active, World worldIn, BlockPos pos) 
	{
		...
		// if smelting, set texture to burning, else set texture to nonburning
