...
public class EntityCentaur extends EntityCow
{
	...
	protected void initEntityAI()
	{
        ...
        this.tasks.addTask(3, new EntityAITempt(this, 1.25D, ItemInit.INGOT_TUTORIAL, false));
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).setBaseValue(0.25D); // slightly faster than cow
	}
	
	@Override
	public float getEyeHeight()
	{
		return 2.6F; // just below it's actual height
	}
