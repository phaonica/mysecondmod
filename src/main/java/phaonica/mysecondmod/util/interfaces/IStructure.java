package phaonica.mysecondmod.util.interfaces;
...
{
	public static final WorldServer worldServer = FMLCommonHandler.instance().getMinecraftServerInstance().getWorld(0); // get overworld
